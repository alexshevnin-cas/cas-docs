...
> **Статус:** Актуально · утверждено владельцем продукта 2026-06-03
...
Продукт устроен как **четыре слоя**. Главное правило: **кабинет ≠ OneBI** — OneBI это слой
...
## 3. Смежные продукты на дата-платформе (вне кабинета)
...
- **Growth / Publishing** — Publishing (Profit Share) [live, UX слит в Analytics]; Creatives Catalog
  на Superset [Project]; сюда же относится старый набор сервисов **Internal/PSV** (паблишинг игр).
- **CAS Configuration** — АРМ монетизатора (заказ из `horyk-portfolio-monetization-brief.md`); часть Слоя 4.

---

## 4. Вне платформенной карты (граница системы)
...
## 5. Реестр проектов (снимок трекера Platforms, 2026-06-03)
...
## 6. Привязка к стратегии (3 уровня роста)
